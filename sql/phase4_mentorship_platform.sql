-- PHASE 4: CLEAN FIX
-- This script handles existing triggers and creates all tables properly

-- Step 1: Create ALL base tables that might be missing
...
-- Step 2: Add user_id columns to all base tables
...
-- Add user_id to learning_progress table
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- Add user_id to user_skills table
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- Add user_id to career_goals table
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- Add mentee_id to mentorship_sessions table
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- Step 3: Create Phase 4 specific tables
...
-- Step 8: Create triggers (only if they don't exist)
DO $$ 
BEGIN
    ...
    -- Create trigger for mentors if it doesn't exist
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_mentors_updated_at' 
        AND event_object_table = 'mentors'
        AND event_object_schema = 'public'
    ) THEN
    ...
    -- Create trigger for learning_progress if it doesn't exist
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_learning_progress_updated_at' 
        AND event_object_table = 'learning_progress'
        AND event_object_schema = 'public'
    ) THEN
    ...
    -- Create trigger for user_skills if it doesn't exist
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_user_skills_updated_at' 
        AND event_object_table = 'user_skills'
        AND event_object_schema = 'public'
    ) THEN
    ...
    -- Create trigger for career_goals if it doesn't exist
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_career_goals_updated_at' 
        AND event_object_table = 'career_goals'
        AND event_object_schema = 'public'
    ) THEN
    ...
    -- Create trigger for mentorship_sessions if it doesn't exist
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_mentorship_sessions_updated_at' 
        AND event_object_table = 'mentorship_sessions'
        AND event_object_schema = 'public'
    ) THEN
...
-- Success message
SELECT 'Phase 4 clean fix completed successfully! All tables created and columns added.' as status;
