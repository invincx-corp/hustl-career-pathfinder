-- =====================================================
-- PHASE 4: PUBLIC USER PROFILES FOR NETWORKING (ORDERED VERSION)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can update their own connection requests" ON public.user_connections;
...
DROP POLICY IF EXISTS "Users can view their own recommendations" ON public.profile_recommendations;
DROP POLICY IF EXISTS "System can create recommendations" ON public.profile_recommendations;
DROP POLICY IF EXISTS "Users can view public activities" ON public.profile_activities;
...
DROP POLICY IF EXISTS "Users can manage their own bookmarks" ON public.profile_bookmarks;
DROP POLICY IF EXISTS "Users can manage their own tags" ON public.profile_tags;
DROP POLICY IF EXISTS "Users can view endorsements" ON public.profile_endorsements;
DROP POLICY IF EXISTS "Users can create endorsements" ON public.profile_endorsements;
DROP POLICY IF EXISTS "Users can update their own endorsements" ON public.profile_endorsements;
DROP POLICY IF EXISTS "Users can create reports" ON public.profile_reports;
DROP POLICY IF EXISTS "Users can view their own reports" ON public.profile_reports;

-- Create public user profiles table FIRST
...
-- Create profile views table LAST (after public_profiles exists)
