-- Fix the notification priority constraint to include 'medium'
-- This script updates the existing constraint without recreating the table

-- Drop the existing constraint
ALTER TABLE public.notifications DROP CONSTRAINT IF EXISTS notifications_priority_check;

-- Add the updated constraint with 'medium' included
...
-- Now insert the sample notifications that were failing
DO $$
BEGIN
