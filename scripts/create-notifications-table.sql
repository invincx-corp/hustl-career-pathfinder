-- Create notifications table with correct constraints from the start
-- This script creates the table and sets up everything properly
...
-- Add trigger for notification_settings
